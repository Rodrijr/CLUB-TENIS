    ...
    function isNumberKey(evt)
    {
        ...
        return false;
                    ...
                    <?php echo form_open('Padre_controller/registrar_padre'); ?>
                               ...
                               <div class='control-group'>
                                ...
                                <div class='controls'>                           
                                    <INPUT TYPE='text' class="form-control" NAME='CI' onkeypress='return validarNro(event)' 
                                           ...
                                           <?php if(isset($entre)) {  echo "value ='var_dump(".$entre['ci_padre'].")'"; 
                                                }
                                           ?> maxlength='10'>
                                    <BR>                                   
                                </div>
                        ...
                        <div class='controls'>                           
                            <INPUT TYPE='text' class="form-control" NAME='NOMBRE' <?php  if(isset($entre)) {  echo "                                                     value ='".$entre['nombre_padre']."'"; } ?> onkeypress='return isNumberKey(event)' maxlength='35'><BR>
                        </div>
                    </div>
                        <div class='control-group'>                            
                        <div class='controls'>         
                             <label for="inputEmail" class="col-lg-2 control-label">APELLIDO:<font color='#FF0000'>*</font></label>
                            <INPUT TYPE='text' class="form-control" NAME='APELLIDO' <?php  if(isset($entre)) {  echo "                                                     value ='".$entre['apellido_padre']."'"; } ?> onkeypress='return isNumberKey(event)' maxlength='35'><BR>
                        </div>
                    </div>
                    ...
                    <div class='control-group'>
                        <div class='controls'>
                           <label class="col-lg-2 control-label"> TELEFONO:<font color='#FF0000'>*</font></label>
                            <INPUT TYPE='text' class="form-control" NAME='TELEFONO' <?php  if(isset($entre)) {  echo "                                                     value ='".$entre['telefono']."'"; } ?>  onkeypress='javascript:return validarNro(event)' maxlength='10'><BR>
                        </div>
                    </div>
                    ...
                    <div class='control-group'>
                        <div class='controls'>
                           <label class="col-lg-2 control-label"> DIRECCION:<font color='#FF0000'>*</font></label>
                            <INPUT TYPE='text' class="form-control" NAME='DIRECCION' <?php  if(isset($entre)) {  echo "                                                     value ='".$entre['ocupacion']."'"; } ?>  maxlength='50' onkeypress='return isNumberKey(event)'><BR>
                        </div>
                    </div>                  
                    ...
                    <div class='control-group'>
                        <div class='controls'>
                            ...
                            <INPUT TYPE='text' class="form-control" NAME='EMAIL' <?php  if(isset($entre)) {  echo "                                                     value ='".$entre['email']."'"; } ?> maxlength='30' ><BR>
                        </div>
                    </div>
