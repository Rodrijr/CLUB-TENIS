    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="page-header">
          <h1 id="forms"> Registrar Alumno</h1>
        </div>
      </div>
    </div>
      <div class="row">
          ...
          <div class="col-lg-5">
            ...
            <div class="input-group">
              ...
              <input type="text" 
                     ...
                     <?php  if(isset($alumno)) 
                        {  
                            echo " value ='".$alumno['nombre_persona']."'"; 
                        } 
                     ?>
                     >
            </div><!-- /input-group -->
          ...
          <div class="col-lg-5">
            <div class="input-group">
              ...
              <input type="text" 
                     ...
                     <?php  if(isset($alumno)) 
                        {  
                            echo " value ='".$alumno['apellido_persona']."'"; 
                        } 
                     ?>
                     >
            </div><!-- /input-group -->
