    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="page-header">
          <h1 id="forms"> Registro UsuariO</h1>
        </div>
      </div>
    </div>
      <div class="row">
     ...
     <div class="row">
      ...
      <div class="col-lg-7">
        <?php echo form_open('padres_controller/registrar_padre_codigo'); ?>
       <div class="row">
          <div class="col-lg-3">
          ...
          <div class="row">
            <legend style="color:blue">Verificacion</legend>
                  <div class="col-lg-5">
            ...
            <div class="input-group">
              ...
              <div class="col-lg-6">
                  En caso de no tener un codigo, contacte con los encargados de la escuela de tenis.
          </div> 
        </div> <br>
        <div class="row">
