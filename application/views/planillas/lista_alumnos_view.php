        ...
        <tbody>
          ...
          <?php foreach ($lista_alumnos as $alumno) {
            echo '<tr>';
              ...
              echo '<td><a href="" style="color:red">Perfil Del Jugador</a></td>';
              echo '<td><a href="" style="color:green">Evaluaci&oacute;n Personal</a></td>';
              echo '<td><a href="" style="color:purple">Objetivos Individuales</a></td>';
            echo '</tr>';
            $cont++;
            } ?>
        </tbody>
